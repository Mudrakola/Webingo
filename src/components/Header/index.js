...
const Header=()=>(
    <div className="header-container">
        <img src="https://webingo.in/images/logo-client/A2-1.png" className="webingo-logo" alt="webingo-logo" />
        <ul className="header-list-container">
            ...
            <li><img src="https://cdn-icons-png.flaticon.com/512/9169/9169633.png" className="call-img" alt="call-img" /></li>
        </ul>
    </div>
)
